$(document).ready(function(){
    ...
    var typed = new Typed(".typing", {
        strings: ["Full Stack Developer", "Designer", "Java Coder"],
        typeSpeed: 100,
        backSpeed: 55,
        loop: true
    });
    ...
    window.open('https://github.com/Swapnilbagga/Freshcery', '_blank');
    });
    ...
    window.open('https://github.com/Swapnilbagga/Chat-Application', '_blank');
  });
  document.getElementById('project3').addEventListener('click', function() {
    window.open('https://github.com/Swapnilbagga/Contact_management_system', '_blank');
  });

  document.getElementById('clickable-text1').addEventListener('click', function() {
    // Redirect to the desired link
    window.open('https://github.com/Swapnilbagga/Dsa_Helper', '_blank');
    });
    ...
    document.getElementById('exp1').addEventListener('click', function() {
        window.open('https://drive.google.com/file/d/1rawIJQlBDBY_bwHKQoUY2cf5c2w_WOjQ/view?usp=sharing', '_blank');
    });
